  ...
  return (
    <div>
      ...
      <nav>
        ...
        <Link className="text-xl px-2 text-blue-500 hover:text-black hover:bg-gray-300 items-center hover:border-b-2 hover:border-purple-400" to="/Bon-plan/meubles">Ajout de meuble et accesoires</Link>
