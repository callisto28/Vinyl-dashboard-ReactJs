...
import CREATE_DESK from "../../graphQl/MutationDesk";
...
const AddDesk = () => {
    ...
    const [createPlanInput] = useMutation(CREATE_DESK, {
        variables: {
            input: {
    ...
    return (
        <div>
            <h1 className="font-bold text-2xl text-purple-500">Ajouter de meubles et accessoires</h1>
            <form
